...
public class Armada extends Ejercito {
	...
	public String toString() {
		...
		return "Armada Id=" + Id + "|Nombre de la base: "+getNombreBase()+"|Lugar de la sede: "+getSede()+"|Número de tropas: "+getNumTropas()+"|Fecha de fundación de la Armada: "+formatter.format(FechaFundacionArmada);
	}
